export const NIGERIAN_STATES_LGAS: Record<string, string[]> = {
  ...
  Jigawa: [
    ...
    "Jahun", "Kafin Hausa", "Kaita", "Kankara", "Kankia", "Karasuwa",
    "Kiri Kasama", "Kiyawa", "Maigatari", "Malam Madori", "Miga", "Ringim",
    "Roni", "Sule Tankarkar", "Taura", "Tudun Wada", "Ungogo", "Warawa",
    "Wudil",
  ],
  Kaduna: [
  ...
  Kogi: [
    ...
    "Ofu", "Ogori/Mangongo", "Okehi", "Okene", "Olamaboro", "Omala",
  ...
  Oyo: [
    ...
    "Ibadan North", "Ibadan North West", "Ibadan South East",
    "Ibadan South West", "Ibarapa Central", "Ibarapa East", "Ibarapa North",
    "Ibarapa West", "Ido", "Irepo", "Iseyin", "Itesiwaju", "Iwajowa",
  ...
  Rivers: [
    ...
    "Asari-Toru", "Bonny", "Degema", "Emuoha", "Etche", "Ikwerre", "Oyigbo",
    "Port Harcourt", "Tai",
    // Add more if needed from original
  ],
  Sokoto: [
    "Bakura", "Bodinga", "Dange Shuni", "Gada", "Goronyo", "Gudu", "Gwadabawa",
