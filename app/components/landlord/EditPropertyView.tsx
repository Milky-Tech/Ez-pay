      ...
      try {
        ...
        if (property && isMounted) {
            setFormData({
              ...
              number_of_units: property.no_of_units?.toString() || property.number_of_units?.toString() || "1",
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            {isAutoSaving ? (
              ...
              <Badge variant="secondary" className="bg-green-50 text-green-600 border-none font-normal text-xs flex gap-1 items-center">
                <CheckCircle className="h-3 w-3" /> Saved {lastSaved.toLocaleTimeString()}
              </Badge>
            ) : null}
          </div>
