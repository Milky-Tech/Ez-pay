        ...
        <div className="p-8 overflow-y-auto flex-grow">
          <div className="max-w-6xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-slate-900 font-raleway">
                  Good day,{" "}
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                      ...
                      <div
                        className={`${stat.color} p-2 rounded-lg text-white group-hover:scale-110 transition-transform`}
                      >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-grow min-w-0">
                            ...
                            <p className="text-sm text-slate-500">
                              {prop.type} • {prop.units} Units Occupied
                            </p>
                          </div>
                          <Badge className="bg-green-50 text-green-700 hover:bg-green-50 border-green-100 hidden sm:flex">
                            {prop.status}
                          </Badge>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-primary text-white border-none shadow-lg overflow-hidden relative">
                  ...
                  <CardContent className="p-6 relative z-10">
                    ...
                    <p className="text-sm text-primary-foreground opacity-90 mb-4">
                      You have 5 pending reviews this week. Keep your response
                      time low for better visibility.
                    </p>
