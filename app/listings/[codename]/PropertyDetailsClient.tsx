...
export default function PropertyDetailsClient({ 
  ...
  const jsonLd = {
    ...
    "name": `${property.typology} in ${property.area}`,
    "description": property.property_address,
    "url": `${BASEURL_SITE}/listings/${codename}`,
    "image": getFullImageUrl(property.exterior_shot),
    "address": {
      "@type": "PostalAddress",
